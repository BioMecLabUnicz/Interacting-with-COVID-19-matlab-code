...
save_fmincon=0; % if true then save the fmincon optimization results
use_fmincon_res=0; %  if true then load the fmincon optimization results

n_changes=3; % number of changes tested
...
if id_country==1    
    ...
    data_QR=data_H(1:47);    % data_QR represet the cumulative sum of the hospital admissions dH
elseif id_country==2
    ...
    data_QR=data_H(1:46);     % data_QR represet the cumulative sum of the hospital admissions dH
...
elseif id_country==3
    ...
    data_QR=data_cumsumH3(1:334); % data_QR represet the cumulative sum of the hospital admissions dH
    
elseif id_country==4
    
    H_0=cum_sum_H0;
    data_dQR=data_dH2(1:301); % data_dQR represents the dH data for fitting
    data_QR=data_cumsum_H2(1:302);  % data_QR represets the cumulative sum of the hospital admissions dH
...
for tag_change=0:n_changes
    ...
    if do_opt  % do the ga optimization
        ...
        init_num_it=1;
        end_num_it=6; % number of ga repetitions
        
        num_it_h_pop=3;
        num_it_init_pop_id=2;
        mtx_par=zeros(end_num_it,n_id_par+1);
        mtx_par_ga=zeros(end_num_it,n_id_par+1);
        ...
        for num_it=init_num_it:end_num_it
            ...
            if tag_change==1
                ...
                elseif id_country==3
                    ...
                    UB_pw=[p1_h 1  1e5  10 160 250 10 ];
                ...
                elseif id_country==4
                    ...
                    UB_pw=[p1_h 1  1e6  10 160 210  10];
                end
            ...
            elseif tag_change==2
                ...
                elseif id_country==4
                    ...
                    UB_pw=[p1_h 1  1e4  10 160 197 10 280 10];
                ...
                elseif id_country==3
                    ...
                    UB_pw=[p1_h  1  1e4  10 160 245 10 305 10];
    ...
    if tag_change>0
        ...
        comp_fpe=perf_fpe_ind(tag_change+1)-(perf_fpe_ind(tag_change)-abs(perf_fpe_ind(tag_change)*thr_score));
         ...
         if (comp_fval<0)&&(comp_aic<0)&& (comp_bic<0)&& (comp_fpe<0)
            ...
            for  tag_change=0:id_sel % plot the results for SIHM_i i=0:id_sel 
            ...
            if id_country==1
                legend({'DE dH data','SIHM_0', 'SIHM_1, (Ph1)','SIHM_1, (Ph2)', 'SIHM_2, (Ph1)','SIHM_2, (Ph2)','SIHM_2, (Ph3)'},'fontsize',9)
                ylim([10 3e4])
            elseif  id_country==2
                ylim([100 4e4])
                legend({'FR dH data','SIHM_0', 'SIHM_1, (Ph1)','SIHM_1, (Ph2)', 'SIHM_2, (Ph1)','SIHM_2, (Ph2)','SIHM_2, (Ph3)'},'fontsize',9)
            elseif id_country==3
                
                legend({'IT dH data','SIHM_0', 'SIHM_1, (Ph1)','SIHM_1, (Ph2)', 'SIHM_2, (Ph1)','SIHM_2, (Ph2)','SIHM_2, (Ph3)'},'fontsize',9)
                ylim([10 6e3])
            elseif id_country==4
                ylim([60 6e3])
                legend({'UK dH data','SIHM_0', 'SIHM_1, (Ph1)','SIHM_1, (Ph2)', 'SIHM_2, (Ph1)','SIHM_2, (Ph2)','SIHM_2, (Ph3)'},'fontsize',9)
            end
