...
% string for defining the line and color of the simulated SIHM model with w^{1}=w0(=0),
...
% tag_change corresponds to k-1, i.e. the number of stepwise changes 
% of the piecewise-constant signal w=w^{k}
